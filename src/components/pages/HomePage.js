...
export default function HomePage() {
    return (
        ...
        <header className="gdl-header">
            ...
            <div className="wp-block-create-block-wrapper gdl-container desktop-only">
                <div className="wp-block-media-text alignwide is-stacked-on-mobile">
                  <figure className="wp-block-media-text__media">
                   <img decoding="async" loading="lazy" width="700" height="600" src="https://digitallibrary.io/wp-content/uploads/2022/10/GDL-front-illustration-1-1.jpeg" alt="" class="wp-image-27118 size-full" srcset="https://digitallibrary.io/wp-content/uploads/2022/10/GDL-front-illustration-1-1.jpeg 800w, https://digitallibrary.io/wp-content/uploads/2022/10/GDL-front-illustration-1-1-300x200.jpeg 300w, https://digitallibrary.io/wp-content/uploads/2022/10/GDL-front-illustration-1-1-768x512.jpeg 768w, https://digitallibrary.io/wp-content/uploads/2022/10/GDL-front-illustration-1-1-50x33.jpeg 50w, https://digitallibrary.io/wp-content/uploads/2022/10/GDL-front-illustration-1-1-100x67.jpeg 100w" sizes="(max-width: 800px) 100vw, 800px"/>
                  </figure>
                <div className="wp-block-media-text__content">
                    <p  class="has-text-color">
                    <strong>The Global Digital Library</strong> provides free, high-quality educational resources for anyone, anywhere.
                    </p>
                </div>
                </div>
            </div>
